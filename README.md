...
Zen（简单冥想）是一个小而安静的冥想网站。它把计时、引导和入门说明放在一起，让用户可以直接开始一次轻量的呼吸与正念练习。本项目基于 Next.js 16（App Router）、Shadcn UI、Tailwind CSS 和 Framer Motion 构建。
...
Zen 是一个小而安静的冥想网站，专注于提供简单、纯粹、可持续的呼吸与正念练习体验，帮助人们在日常生活中留出一点安静时间。
