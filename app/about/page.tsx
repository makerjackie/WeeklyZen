    ...
    >
      ...
      <section className="relative overflow-hidden py-16 sm:py-20">
        ...
        <div className="absolute inset-0 -z-10 opacity-30">
          <div
            className={`absolute inset-0 ${isDarkTheme ? 'bg-gradient-to-b from-blue-950/50 to-indigo-950/80' : 'bg-gradient-to-b from-blue-100/50 to-indigo-100/80'}`}
          />
          <div
            className={`absolute left-0 top-0 h-[1px] w-full bg-gradient-to-r from-transparent ${isDarkTheme ? 'via-indigo-500/20' : 'via-blue-500/20'} to-transparent`}
          />
        ...
        <div className="container mx-auto max-w-4xl px-4">
          ...
          >
            <h1
              className={`text-3xl font-light sm:text-4xl md:text-5xl ${themeStyles.primaryText} mb-6 leading-tight`}
            >
              {t('关于我们', 'About Us')}
            </h1>
            <p className={`${themeStyles.secondaryText} mx-auto max-w-2xl`}>
              {t(
      ...
      <section className="pb-20">
        <div className="container mx-auto max-w-4xl px-4">
          <motion.div
            ...
            className={`${themeStyles.cardBackground} rounded-2xl border p-8 backdrop-blur-md md:p-12 ${themeStyles.cardBorder} shadow-lg ${isDarkTheme ? 'shadow-indigo-900/5' : 'shadow-blue-300/5'}`}
          >
            {/* 第一部分：我们的故事 */}
            <div className="mb-12">
              <h2
            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div
                  className={`${isDarkTheme ? 'bg-indigo-900/20' : 'bg-blue-50/80'} rounded-xl border p-6 ${isDarkTheme ? 'border-indigo-600/10' : 'border-blue-200/50'}`}
                >
                  <h3
                    className={`text-xl font-medium ${themeStyles.primaryText} mb-3`}
                  >
            ...
            <div className="mb-12">
              ...
              <div className="space-y-8">
                <div className="flex flex-col gap-6 md:flex-row">
                  <div
                    className={`flex-1 ${isDarkTheme ? 'bg-indigo-900/20' : 'bg-blue-50/80'} rounded-xl border p-6 ${isDarkTheme ? 'border-indigo-600/10' : 'border-blue-200/50'}`}
                  >
                    <h3
                      className={`text-xl font-medium ${themeStyles.primaryText} mb-3`}
                    >
                    ...
                    <ul
                      className={`space-y-3 ${isDarkTheme ? 'text-indigo-100/90' : 'text-slate-700'}`}
                    >
                      <li className="flex items-start">
                        <span
                          className={`${isDarkTheme ? 'text-indigo-400' : 'text-blue-500'} mr-2`}
                        >
                          •
                        </span>
                        <div>
                          <strong>
                            {t('使用冥想计时器', 'Use the Meditation Timer')}
                          </strong>
                          <p>
                            {t(
                              '从 5 分钟开始，跟随呼吸球慢慢稳定下来。',
                              'Start with 5 minutes and settle in with the breathing sphere.'
                            )}
                          </p>
                        </div>
                      </li>
                      <li className="flex items-start">
                        ...
                        <div>
                          <strong>
                            {t('选择引导语', 'Choose a Guidance Track')}
                          </strong>
                          <p>
                            {t(
                              '可以选择无引导语、基础引导，或者呼吸练习。',
                              'Choose no guidance, a basic guide, or a breathing practice.'
                            )}
                          </p>
                        </div>
                      </li>
                  ...
                  >
                    ...
                    >
                      <li className="flex items-start">
                        ...
                        <div>
                          <strong>
                            {t('阅读入门说明', 'Read the Beginner Guide')}
                          </strong>
                          <p>
                            {t(
                              '从姿势、呼吸到常见问题，先建立一个温和的开始。',
                              'Build a gentle start with guidance on posture, breathing, and common beginner questions.'
                            )}
                          </p>
                        </div>
                      </li>
                      <li className="flex items-start">
                        ...
                        <div>
                          <strong>
                            {t('按自己的节奏练习', 'Practice at Your Own Pace')}
                          </strong>
                          <p>
                            {t(
                              '哪怕只是短短几分钟，稳定而重复的练习也很有价值。',
                              'Even a few minutes at a time can be valuable when your practice is steady and repeatable.'
                            )}
                          </p>
                        </div>
                      </li>
            ...
            {/* 开始练习 */}
            <div
              className={`${isDarkTheme ? 'bg-indigo-900/30' : 'bg-blue-50/80'} rounded-2xl border p-8 ${isDarkTheme ? 'border-indigo-600/20' : 'border-blue-200/50'} mb-10 text-center`}
            >
              <h2
                className={`text-2xl font-light ${themeStyles.primaryText} mb-4`}
              >
                {t('准备开始了吗？', 'Ready to Begin?')}
              </h2>
              <p
                className={`${isDarkTheme ? 'text-indigo-100/90' : 'text-slate-700'} mx-auto mb-6 max-w-2xl leading-relaxed`}
              >
                {t(
              ...
              <div className="flex justify-center gap-4">
                ...
                <Link href="/introduction">
                  <Button
                    variant="outline"
                    className={`rounded-full px-8 py-2 ${isDarkTheme ? 'border-indigo-600/30 text-indigo-300 hover:bg-indigo-950/50' : 'border-blue-300/50 text-blue-600 hover:bg-blue-50'}`}
                  >
            ...
            <div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className={`${isDarkTheme ? 'border-indigo-600/10 bg-indigo-900/20 text-indigo-100/90 hover:bg-indigo-900/30' : 'border-blue-200/50 bg-blue-50/80 text-slate-700 hover:bg-blue-100/80'} rounded-xl border p-5 transition-colors`}
                >
                  <div
                    className={`mb-2 text-base font-medium ${themeStyles.primaryText}`}
                  >
                    makerjackie
                  </div>
                  <div className="text-sm opacity-80">
                    {t(
                      '产品发起、设计与开发。',
                      'Product creation, design, and development.'
                    )}
                  </div>
                </a>
                <a
                  href="https://github.com/perMAIN"
                  target="_blank"
                  rel="noreferrer"
                  className={`${isDarkTheme ? 'border-indigo-600/10 bg-indigo-900/20 text-indigo-100/90 hover:bg-indigo-900/30' : 'border-blue-200/50 bg-blue-50/80 text-slate-700 hover:bg-blue-100/80'} rounded-xl border p-5 transition-colors`}
                >
