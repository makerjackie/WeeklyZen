...
export default function RefactoredMeditationPage() {
  ...
  }, [audio, dialogs, showEncouragement])
  ...
  return (
    <div className={`min-h-screen ${bgGradient} ${textColor} flex flex-col`}>
      <MeditationHeader
        ...
        onGuidanceClick={() =>
          dialogs.handleShowGuidanceDialog(audio.isPlaying)
        }
      ...
      <MeditationDialogController
        ...
        onCustomAudioGenerated={(audioUrl: string | undefined) =>
          audioUrl && audio.handleCustomAudioGenerated(audioUrl)
        }
        // 对话框控制
